$filePath = 'force-app\main\default\profiles\BrokerPortal Profile.profile-meta.xml'
...
# Remove ZVC application visibility block
...
# Remove gupshup application visibility block (false variant)
...
# Remove gupshup application visibility block (true variant)
...
# Remove nativevideocmpt application visibility block (false variant)
...
# Remove nativevideocmpt application visibility block (true variant)
...
# Remove ZVC classAccesses blocks
...
# Remove ZVC apex page references
...
# Remove ZVC tab visibility references
